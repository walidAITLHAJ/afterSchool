		...
		<img src="assets/img/logo.png" alt="AfterSchool" style="width: 200px; margin-bottom:50px">
                            ...
                            <form class="user" method="post" action="functions/register_info.php">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6"><input class="form-control form-control-user" type="text" id="exampleFirstName" placeholder="Last Name" name="last_name" required=""></div>
                                </div>
                                ...
                                <div class="form-group">
                                    <input class="form-control form-control-user" type="text" id="exampleFirstName" placeholder="Code Apogée / CNE" name="code" required="">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input class="form-control form-control-user" type="password" id="examplePasswordInput" placeholder="Password" name="password" onKeyUp="checkPasswordStrength();" required="">
